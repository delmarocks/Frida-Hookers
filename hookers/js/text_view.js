...
var TEXT_VIEW_CATEGORY = "text-view";

function emitEvent(message, details) {
    if (typeof Hookers !== "undefined") {
        Hookers.event(TEXT_VIEW_CATEGORY, message, details);
        return;
    }
    console.log("[text-view] " + message);
}
...
Java.perform(function() {
    ...
    if (textViewClz.setText) {
        ...
        setTextFunc.implementation = function(v0) {
            ...
            emitEvent("捕获到 TextView.setText()", {
                viewClass: clz,
                viewId: viewId,
                text: v0 ? v0.toString() : ""
            });
    ...
    if (textViewClz.getText) {
        ...
        getTextFunc.implementation = function() {
            ...
            emitEvent("捕获到 TextView.getText()", {
                viewClass: clz,
                viewId: viewId,
                text: editable ? editable.toString() : ""
            });
            return editable;
        };
    }
